...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2023 a las 22:43:04
...
('DoctrineMigrations\\Version20230307145101', '2023-03-07 15:51:10', 53);
...
INSERT INTO `eventos` (`id`, `nombre`, `juego`, `fecha`) VALUES
(1, 'Torneo de Ajedrez Estatal', 'Ajedrez', '08-03-2023'),
(2, 'Torneo Bang Semanal', 'BANG', '08-03-2023');
...
(48, 71.5, 39, 200, 200, '08-03-2023'),
(49, 306.5, 36, 100, 150, '08-03-2023'),
(50, 393.5, 203, 180, 180, '08-03-2023'),
(51, 41.5, 276, 300, 300, '08-03-2023'),
(52, 393.5, 417, 150, 250, '08-03-2023'),
(53, 0, 0, 90, 90, '08-03-2023'),
(54, 0, 0, 23, 23, '08-03-2023');
...
INSERT INTO `participacion` (`id`, `evento`, `usuario`) VALUES
(1, 1, 3),
(2, 2, 3),
(3, 2, 1);
...
(3, 'metin2lahermandaz@gmail.com', '$2y$13$BFNJ1OmRTPF4GvnSsLrD5O1uvkJRxpnk4PizjZ1SCqqj20XJma7au', 'josepa', '[]');
