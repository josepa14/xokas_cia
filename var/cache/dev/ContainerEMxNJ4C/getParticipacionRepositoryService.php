 ...
 */
class getParticipacionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipacionRepository' shared autowired service.
     *
     * @return \App\Repository\ParticipacionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipacionRepository.php';

        return $container->privates['App\\Repository\\ParticipacionRepository'] = new \App\Repository\ParticipacionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
