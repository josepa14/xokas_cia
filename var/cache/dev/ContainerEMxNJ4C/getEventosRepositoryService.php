 ...
 */
class getEventosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EventosRepository' shared autowired service.
     *
     * @return \App\Repository\EventosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EventosRepository.php';

        return $container->privates['App\\Repository\\EventosRepository'] = new \App\Repository\EventosRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
