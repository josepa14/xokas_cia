...
class __TwigTemplate_2e1385219038d3af97eb48dca9a93198 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Edit Juegos</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "juegos/_form.html.twig", ["button_label" => "Update"]);
        echo "
...
{% block title %}Edit Juegos{% endblock %}

{% block body %}
    <h1>Edit Juegos</h1>

    {{ include('juegos/_form.html.twig', {'button_label': 'Update'}) }}
