...
\t\t\tconst filters = filters = JSON.parse('";
        // line 5
        echo json_encode(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 5, $this->source); })()), "user", [], "any", false, false, false, 5), "roles", [], "any", false, false, false, 5));
        echo "');
\t\t</script>
\t
\t<div class=\"container\">
...
";
    ...
    {
        return array (  122 => 56,  106 => 42,  95 => 33,  93 => 32,  63 => 5,  59 => 3,  52 => 2,  35 => 1,);
    }
...
\t\t<script>
\t\t\tconst filters = filters = JSON.parse('{{ app.user.roles | json_encode | raw }}');
\t\t</script>
\t
\t<div class=\"container\">
\t\t<h1>Reservas</h1>
