...
/* juegos/_form.html.twig */
class __TwigTemplate_f1b483a2d7c17cb3ae5ba8ba9ab802ca extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "juegos/_form.html.twig"));
...
{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"btn btn-info m-1\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
</div>
