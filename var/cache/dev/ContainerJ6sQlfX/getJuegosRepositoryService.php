 ...
 */
class getJuegosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JuegosRepository' shared autowired service.
     *
     * @return \App\Repository\JuegosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JuegosRepository.php';

        return $container->privates['App\\Repository\\JuegosRepository'] = new \App\Repository\JuegosRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
