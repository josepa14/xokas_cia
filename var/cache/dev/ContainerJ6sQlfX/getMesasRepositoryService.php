 ...
 */
class getMesasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MesasRepository' shared autowired service.
     *
     * @return \App\Repository\MesasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MesasRepository.php';

        return $container->privates['App\\Repository\\MesasRepository'] = new \App\Repository\MesasRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
